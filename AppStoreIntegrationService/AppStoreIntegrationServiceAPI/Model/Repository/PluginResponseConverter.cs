...
namespace AppStoreIntegrationServiceAPI.Model.Repository
{
    ...
    {
        public PluginResponse<PluginDetailsBase<PluginVersionBase<ProductDetails>, CategoryDetails>> CreateOldResponse(PluginResponse<PluginDetails<PluginVersion<string>, string>> newResponse)
        {
        ...
        public PluginResponse<PluginDetailsBase<PluginVersionBase<string>, string>> CreateBaseResponse(PluginResponse<PluginDetails<PluginVersion<string>, string>> response)
        {
        ...
        private static PluginDetailsBase<PluginVersionBase<ProductDetails>, CategoryDetails> ConvertToOldPlugin(PluginDetails<PluginVersion<string>, string> plugin, IEnumerable<CategoryDetails> categories, IEnumerable<ProductDetails> products)
        {
        ...
        private static void ConvertToOldVersion(PluginVersion<string> version, List<PluginVersionBase<ProductDetails>> newVersions, IEnumerable<ProductDetails> products)
        {
